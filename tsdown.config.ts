...
function runtimeDependencyPlugin() {
  const paths = new Map([
    ...
    ['@univerjs-pro/slides-chart', nodeRequire.resolve('@univerjs-pro/slides-chart/lib/es/index.js')],
    ['@univerjs-pro/slides-chart/facade', nodeRequire.resolve('@univerjs-pro/slides-chart/lib/es/facade.js')],
    ['@univerjs-pro/slides-chart-ui', nodeRequire.resolve('@univerjs-pro/slides-chart-ui/lib/es/index.js')],
    ['@univerjs-pro/chart-ui', nodeRequire.resolve('@univerjs-pro/chart-ui/lib/es/index.js')],
    ['@univerjs-pro/slides-ui', nodeRequire.resolve('@univerjs-pro/slides-ui/lib/es/index.js')],
    ['@univerjs-pro/engine-chart/facade', nodeRequire.resolve('@univerjs-pro/engine-chart/lib/es/facade.js')],
    ...
    ['@univerjs-pro/chart-ui/lib/index.css', CSS_PREFIX + nodeRequire.resolve('@univerjs-pro/chart-ui/lib/index.css') + CSS_SUFFIX],
    ['@univerjs-pro/slides-chart-ui/lib/index.css', CSS_PREFIX + nodeRequire.resolve('@univerjs-pro/slides-chart-ui/lib/index.css') + CSS_SUFFIX],
...
export default defineConfig([
  ...
  },
  {
    ...
    external: [/^@deepseek-ai\//],
    noExternal: ['react', 'react-dom', 'react/jsx-runtime', 'react-dom/client', '@wendellhu/redi', '@wendellhu/redi/react-bindings', 'rxjs', 'rxjs/operators', '@univerjs-pro/license', '@univerjs-pro/docs-table', '@univerjs-pro/docs-table/facade', '@univerjs-pro/shape-editor-ui', '@univerjs-pro/shape-editor-ui/locale/en-US', '@univerjs-pro/shape-editor-ui/locale/zh-CN', '@univerjs-pro/slides', '@univerjs-pro/slides/facade', '@univerjs-pro/slides-chart', '@univerjs-pro/slides-chart/facade', '@univerjs-pro/slides-chart-ui', '@univerjs-pro/slides-chart-ui/locale/en-US', '@univerjs-pro/slides-chart-ui/locale/zh-CN', '@univerjs-pro/slides-chart-ui/lib/index.css', '@univerjs-pro/chart-ui', '@univerjs-pro/chart-ui/locale/en-US', '@univerjs-pro/chart-ui/locale/zh-CN', '@univerjs-pro/chart-ui/lib/index.css', '@univerjs-pro/slides-ui', '@univerjs-pro/slides-ui/locale/en-US', '@univerjs-pro/slides-ui/locale/zh-CN', '@univerjs-pro/engine-shape', '@univerjs-pro/engine-shape/facade', '@univerjs-pro/engine-chart', '@univerjs-pro/engine-chart/facade', '@univerjs-pro/engine-formula', /^@univerjs\//],
    plugins: [dedupeRediPlugin(), runtimeDependencyPlugin(), univerLicensePlugin(), cssPlugin()],
    outputOptions: {
